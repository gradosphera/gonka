...
var (
	...
	fd_ExcludedParticipant_effective_height protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ExcludedParticipant_effective_height = md_ExcludedParticipant.Fields().ByName("effective_height")
}
...
func (x *fastReflection_ExcludedParticipant) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EffectiveHeight != uint64(0) {
		...
		if !f(fd_ExcludedParticipant_effective_height, value) {
			return
		}
	}
}
...
func (x *fastReflection_ExcludedParticipant) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.ExcludedParticipant.reason":
		return x.Reason != ""
	case "inference.inference.ExcludedParticipant.effective_height":
...
func (x *fastReflection_ExcludedParticipant) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.ExcludedParticipant.effective_height":
		panic(fmt.Errorf("field effective_height of message inference.inference.ExcludedParticipant is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.ExcludedParticipant"))
		}
...
type ExcludedParticipant struct {
	...
	EffectiveHeight uint64 `protobuf:"varint,4,opt,name=effective_height,json=effectiveHeight,proto3" json:"effective_height,omitempty"` // Block height when exclusion took effect
}
...
func (x *ExcludedParticipant) GetEffectiveHeight() uint64 {
	if x != nil {
...
var file_inference_inference_excluded_participant_proto_rawDesc = []byte{
	...
	0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x01, 0x0a, 0x13,
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x10, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74,
	0x69, 0x76, 0x65, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x0f, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x69, 0x76, 0x65, 0x48, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x42, 0xc6, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x18, 0x45,
	0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61,
